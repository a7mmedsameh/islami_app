...
class FooterQuranPlayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          getIt<AudioCubit>()..setAudioSource(detailsSura.number ?? 1),
          ...
          return Container(
            ...
            child: state.maybeWhen(
              ...
              success: (isPlaying, volume, position, total) {
                return setupSuccess(total, position, audioCubit, isPlaying, volume, context);
              },
  ...
  Column setupSuccess(Duration total, Duration position, AudioCubit audioCubit, bool isPlaying, double volume, BuildContext context) {
    return Column(
                ...
                children: [
                  Slider(
                    ...
                    value: position.inMilliseconds
                        ...
                        .toDouble(),
                    onChanged: (value) => audioCubit.seek(
